  ...
  setores: [
    {
      ...
      clienteId: 'cliente-1',
      cor: '#2563EB',
      descricao: 'Atendimento e área de espera',
      responsavel: 'Equipe recepção',
    },
    {
      id: 'setor-2',
      nome: 'Câmara fria',
      clienteId: 'cliente-1',
      cor: '#DC2626',
      descricao: 'Área refrigerada de estoque',
      responsavel: 'Operação loja',
    },
    {
      id: 'setor-3',
      nome: 'Produção',
  ...
  orcamentos: [
    {
      ...
      titulo: 'Troca de controlador da câmara fria',
      total: 1250,
    },
  ],
};
