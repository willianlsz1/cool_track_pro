...
- `#dash-alerts-section`, `#dash-critical-section`, `#dash-criticos-section`, `#dash-recentes-section` e os cards Pro read-only foram protegidos por `src/__tests__/dashboardLegacyReadOnlyBlocks.test.js`, incluindo XSS nos cards de alerta mini.
